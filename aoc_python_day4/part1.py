...
def next_letter_is_surrounding(ws: list[list[str]], letter: str, current_pos: tuple[int, int], direction: tuple[int, int]) -> int:
    ...
    if found_letter == letter:
        if letter == last_letter:
            ...
            return next_letter_is_surrounding(ws, letters[found_letter], next_pos, direction)
